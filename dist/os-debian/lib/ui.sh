...
: "${FRANKLIN_UI_COLOR_INFO_BAR:=$CAMPFIRE_PRIMARY_BAR}"
: "${FRANKLIN_UI_COLOR_INFO_BG:=$CAMPFIRE_PRIMARY_800_BG}"
: "${FRANKLIN_UI_COLOR_INFO_BG_LIGHT:=$CAMPFIRE_PRIMARY_600_BG}"
: "${FRANKLIN_UI_COLOR_INFO_FG:=$CAMPFIRE_PRIMARY_TEXT_LIGHT}"
: "${FRANKLIN_UI_COLOR_INFO_TEXT:=$CAMPFIRE_PRIMARY_TEXT_LIGHT}"
